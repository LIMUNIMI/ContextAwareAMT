...
+-------------+------------+-----------------+--------+
| pianoteq0   | 0.2646     |   0.2135        |  24    |
|             +            +-----------------+--------+
|             |            |   0.2099        |  23    |
|             +            +-----------------+--------+
|             |            |   0.2097        |  23    |
+-------------+------------+-----------------+--------+
| pianoteq1   | 0.2737     |   0.2333        |  500   |
|             +            +-----------------+--------+
|             |            |   0.2312        |  500   |
|             +            +-----------------+--------+
|             |            |   0.2314        |  500   |
+-------------+------------+-----------------+--------+
| pianoteq2   | 0.2962     |   0.2150        |  41    |
|             +            +-----------------+--------+
|             |            |   0.2162        |  42    |
|             +            +-----------------+--------+
|             |            |   0.2136        |  20    |
+-------------+------------+-----------------+--------+
| pianoteq3   | 0.3264     |   0.2052        |  22    |
|             +            +-----------------+--------+
|             |            |   0.1998        |  38    |
|             +            +-----------------+--------+
|             |            |   0.1996        |  20    |
+-------------+------------+-----------------+--------+
| salamander0 | 0.3105     |   0.2374        |  24    |
|             +            +-----------------+--------+
|             |            |   0.2335        |  39    |
|             +            +-----------------+--------+
|             |            |   0.2334        |  20    |
+-------------+------------+-----------------+--------+
| salamander1 | 0.3180     |   0.2086        |  45    |
|             +            +-----------------+--------+
|             |            |   0.1997        |  30    |
|             +            +-----------------+--------+
|             |            |   0.1995        |  20    |
